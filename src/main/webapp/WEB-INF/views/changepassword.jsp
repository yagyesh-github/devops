...
<html>
<head>
	<title>Sporty Shoes General Store | Change Password </title>
				...
				<div class="col-md-12">
					<form action="${pageContext.request.contextPath}/customer/changeCustomerPassword" method="post">
						<div class="form-group">
							...
							<input type="password" placeholder="Password" size="35" maxlength="64"  class="form-control" name="password" required="required" />
						</div>	
						<div class="form-group">
							<label class="col-form-label">Confirm Password</label>
							<input type="password" size="35" placeholder="Confirm Password" maxlength="64"  class="form-control" name="confirm-password" id="password" required="required" />					
						</div>
						<div class="right-w3l">
