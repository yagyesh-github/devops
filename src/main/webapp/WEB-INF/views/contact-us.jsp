...
<html>
<head>
	<title>Sporty Shoes General Store | Contact </title>
			...
			<div class="row contact-grids agile-1 mb-5">
				<div class="col-sm-4 contact-grid agileinfo-6 mt-sm-0 mt-2">
					<div class="contact-grid1 text-center">
						...
						<p style="font-weight: bold;color:black;">Sporty Shoes General Store
...
<!-- 							<label>+(91) 121 122 000</label> -->
			...
			<!-- //form -->
			<br>
					<div style="text-align:center" id="success" style="color: green;font-weight: bold;font-size: 15px;"></div>
					<div style="text-align:center" id="error" style="color: green;font-weight: bold;font-size: 15px;"></div>
  
  <img src="${pageContext.request.contextPath}/images/loader.gif" alt="loader" style="text-align:center" style="width: 150px;height: 120px;" id="loader">
	...
	<!---728x90--->
	<!-- map -->
	<div class="map mt-sm-0 mt-4"></div>
	<!-- //map -->	
